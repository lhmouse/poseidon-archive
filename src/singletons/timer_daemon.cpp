...
namespace {
		...
		boost::uint64_t timePoint, boost::uint64_t period, TimerCallback callback, bool isLowLevel)
	{
		AUTO(item, boost::make_shared<TimerItem>(
			period, boost::make_shared<TimerCallback>(STD_MOVE(callback)), isLowLevel));
