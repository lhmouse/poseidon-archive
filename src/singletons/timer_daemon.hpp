...
public:
	...
	typedef boost::function<void (const boost::shared_ptr<Timer> &item, boost::uint64_t now, boost::uint64_t period)> Timer_callback;
	...
	static boost::shared_ptr<Timer> register_absolute_timer(boost::uint64_t first, boost::uint64_t period, Timer_callback callback);
	static boost::shared_ptr<Timer> register_timer(boost::uint64_t delta_first, boost::uint64_t period, Timer_callback callback);
	...
	static boost::shared_ptr<Timer> register_low_level_absolute_timer(boost::uint64_t first, boost::uint64_t period, Timer_callback callback);
	static boost::shared_ptr<Timer> register_low_level_timer(boost::uint64_t delta_first, boost::uint64_t period, Timer_callback callback);
