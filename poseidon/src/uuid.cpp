...
namespace {
	CONSTEXPR const unsigned char g_bytes_min[16] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
	CONSTEXPR const unsigned char g_bytes_max[16] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
...
Uuid::Uuid(const char (&str)[36]){
	POSEIDON_THROW_UNLESS(from_string(str), Exception, Rcnts::view("Invalid UUID string"));
}
