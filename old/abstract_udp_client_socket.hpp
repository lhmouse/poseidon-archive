...
#ifndef POSEIDON_SOCKET_ABSTRACT_UDP_CLIENT_SOCKET_
#define POSEIDON_SOCKET_ABSTRACT_UDP_CLIENT_SOCKET_
...
class Abstract_UDP_Client_Socket
  ...
  protected:
    ...
    virtual
    void
    do_socket_on_packet(const Socket_Address& addr, char* data, size_t size)
      = 0;
